...
| [contree](contree/README.md) | `claude plugin install contree@susu-eng` (Claude Code) — Codex CLI: install from this repo via `/plugins` (skills only, no hooks) | Test trees as living requirements — TDD with auto-synced specs in CLAUDE.md |
