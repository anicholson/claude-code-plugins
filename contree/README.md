...
**Codex CLI** — install via `/plugins` in the Codex CLI, pointing at this repository. Skills and hooks both run; Codex sets `CLAUDE_PLUGIN_ROOT` in hook command env so the existing scripts work unchanged.
